                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
                  ...
                  <div className="max-w-3xl mb-16 text-center sm:text-left">
                    <span className="text-xs font-bold uppercase tracking-widest text-[#B48F57] block mb-3 font-sans">
                      • TRỤ CỘT ĐỊNH VỊ & GIÁ TRỊ CỐT LÕI GAMA
                    </span>
                    <h2 className="text-3xl sm:text-[40px] font-serif font-extrabold text-[#0A4E35] tracking-tight leading-[1.15]">
                      Kiên định trong từng cam kết, đồng hành cùng mỗi mái ấm Việt.
                    </h2>
                  </div>
              ...
              <section className="py-20 bg-white px-6 sm:px-12 overflow-hidden">
                <div className="max-w-7xl mx-auto bg-gradient-to-r from-[#05473E] to-[#02221C] rounded-[36px] p-12 sm:p-24 relative overflow-hidden flex flex-col items-center text-center shadow-2xl border border-white/5">
                  ...
                  <div className="z-10 max-w-3xl flex flex-col items-center">
                    <h2 className="text-3xl sm:text-[48px] lg:text-[56px] font-serif font-extrabold text-white leading-[1.1] mb-6">
                      Mưa nắng ngoài thềm.<br className="sm:hidden" /> Bình yên trong tổ ấm.
                    </h2>
                    <p className="text-xs sm:text-sm md:text-base text-gray-300 font-sans leading-relaxed mb-10 max-w-xl font-light">
                      Những gì chúng tôi tinh chế hôm nay sẽ âm thầm che chở từng nhịp thở của ngôi nhà bạn mai sau. Lớp bảo vệ kiên cường của GAMA mang lại sự vững chãi bền lâu, nâng niu trọn vẹn từng khoảnh khắc bình yên.
                    </p>
                    <button
                    ...
                    >
                      <span>Khởi đầu hành trình kiến tạo</span>
